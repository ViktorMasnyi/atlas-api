...
describe('CrimeAnalysisService Integration', () => {
  ...
  beforeEach(async () => {
    ...
    mockCrimeDataRepository.create.mockImplementation((data) => data);
    mockCrimeDataRepository.save.mockImplementation((data) =>
